...
This idea is already about a year old. There is a lot of information, many materials, but very little progress.

### Concept:

- a case from a Mavic 3T drone;
- 3–4 FPV batteries inside;
- control board / charging board;
- laptop power supply;
...
HOTA GaN is the most expensive part in this case. It works well — it solves many problems with a single device.

Link: [https://pyrodrone.com/products/hota-p24-pd-charger-248w-usb-w-xt60-input-grey](https://pyrodrone.com/products/hota-p24-pd-charger-248w-usb-w-xt60-input-grey) 

---

A concept from the guys in Europe. Already tested [https://www.dropbox.com/scl/fi/cspe7l0vlwsd1uf9xz83f/Charging-station-concept.mp4?rlkey=x7tm1f6nsd6jo7pfb4qe0k1w7&s[...] So even if we simply provide our posts with such charging stations — it's already necessary to do at least[...]

# Reason

Volunteers from Germany are collecting an "EcoFlow" for us, which costs €649. But at some posts such charging stations[...]

# How it works now

Right now the Germans buy new EcoFlow units for us.

Then:

1. They are sent to the Netherlands, where we have a logistics hub.
2. Then everything is loaded into the car of our "smuggler" — a military chaplain.
3. He brings it into Ukraine.
4. Then in Chernivtsi there is a logistics hub of the Ukrainian foundation.
5. There, everything is repackaged and sent to different units.

---

# How it could be

Instead of ready-made EcoFlow units:

- a batch of wires is purchased;
- the necessary boards are purchased;
- Mavic cases;
- electronics;
- components.

All of this goes to Ukraine, and here we assemble and distribute the finished solutions among the units.

---

## Scale of the problem

In our unmanned systems company we currently have 9 posts. In my platoon there are already two posts, but that is not the limit.

One of my "Vampire" posts — equipment worth approximately €2,300. And that is without "Vampir" batteries and without the drone itself "Vam[...]
...
These boxes can also be handed out to houses where servicemen live — as large power banks for backup power[...]

### We have different volunteers

Recently they ordered for us about €500 worth of various boards and wires so that we could "play around" and make[...]

I have been gathering information on this topic for over a year. So far we only have the first prototype. Maybe, in a few [...]
